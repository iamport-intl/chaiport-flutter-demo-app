...
class CheckoutElements extends StatefulWidget {
  static String routeName = "/checkout_elements";
  GlobalCheckoutRequest checkoutRequest;

  CheckoutElements({key, required this.checkoutRequest});

  @override
  State<CheckoutElements> createState() => _CheckoutElementsState();
}

class _CheckoutElementsState extends State<CheckoutElements> {
